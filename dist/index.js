...
var PlayIt = /** @class */ (function () {
  function PlayIt() {
    ...
    this.downloadUrls = {
      ...
      mac:
        'https://playit.gg/downloads/playit-darwin_64-' + this.version + '.zip',
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.fetch('/account/tunnels/' + id + '/disable')
            ];
          case 1:
            _a.sent();
            return [2 /*return*/];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.fetch('/account/tunnels/' + id + '/enable')
            ];
          case 1:
            _a.sent();
            return [2 /*return*/];
  ...
  PlayIt.prototype.createTunnel = function (tunnelOpts) {
    if (tunnelOpts === void 0) {
      tunnelOpts = isRequired('Tunnel Options');
    }
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_j) {
        switch (_j.label) {
          case 0:
            (_a = tunnelOpts.proto),
              (proto = _a === void 0 ? 'TCP' : _a),
              (_b = tunnelOpts.port),
              (port = _b === void 0 ? isRequired('Port') : _b);
            _c = this.fetch;
            _d = ['/account/tunnels'];
            _g = {
              method: 'POST'
          ...
          case 2:
            return [
              ...
              _c.apply(
                ...
                _d.concat([
                  ((_g.body = _f.apply(_e, [
                    ((_h.agent_id = _j.sent().agents.find(function (agent) {
                      return agent.key === _this.agent_key;
                    }).id),
                    (_h.domain_id = null),
                    _h)
                  ])),
                  ...
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      ...
                      case 2:
                        ...
                        otherData = _a.sent().tunnels.find(function (tunnel) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_l) {
        switch (_l.label) {
          ...
          case 1:
            _a.binary = _l.sent();
            dotenvStream = fs_extra_1['default'].createWriteStream(
              this.dir + '/.env',
              {
                flags: 'w+'
              }
          ...
          case 9:
            ...
            return [
              4 /*yield*/,
              fs_extra_1['default'].pathExists(this.configFile)
            ];
          case 10:
          ...
          case 11:
            ...
            _l.label = 12;
          case 12:
            return [4 /*yield*/, fs_extra_1['default'].chmod(this.binary, 511)];
          case 13:
            _l.sent();
            ...
            this.playit.stdout.on('data', function (data) {
              _this.output += data + '\n';
              _this.stdout += data + '\n';
              outputCallbacks.map(function (callback) {
                return callback(data.toString());
              });
              stdoutCallbacks.map(function (callback) {
                return callback(data.toString());
              });
            });
            this.playit.stderr.on('data', function (data) {
              ...
              stderrCallbacks.map(function (callback) {
                return callback(data.toString());
              });
              if (data.toString().includes('ERRO')) {
                _this.errors += data + '\n';
                errorCallbacks.map(function (callback) {
                  return callback(data.toString());
                });
              } else if (data.toString().includes('WARN')) {
                _this.warnings += data + '\n';
                warningCallbacks.map(function (callback) {
                  return callback(data.toString());
                });
              }
            });
          ...
          case 14:
            ...
            return [
              4 /*yield*/,
              fs_extra_1['default'].readFile(this.configFile, 'utf-8')
            ];
          case 15:
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_m) {
        switch (_m.label) {
          ...
          case 1:
            if (_m.sent()) return [2 /*return*/, file];
            ...
            return [
              4 /*yield*/,
              (0, make_fetch_happen_1['default'])(this.downloadUrls[this.os])
            ];
          case 2:
            return [4 /*yield*/, _m.sent().arrayBuffer()];
          case 3:
            return [4 /*yield*/, _d.apply(_c, [_f.apply(_e, [_m.sent()])])];
          case 4:
            return [
              4 /*yield*/,
              _b.apply(_a, [
                _m.sent().files.map(function (zipFile) {
                  return __awaiter(_this, void 0, void 0, function () {
                    var _a, _b, _c, _d;
          ...
          case 8:
            return [
              4 /*yield*/,
              _h.apply(_g, _j.concat([_l.apply(_k, [_m.sent()])]))
            ];
          case 9:
            _m.sent();
            _m.label = 10;
            ...
            return [
              ...
              new Promise(function (res) {
                return _this.onStderr(function (data) {
                  var _a;
                  return (
                    (_a = data.match(/https:\/\/[0-9a-z\.\/]*/gi)) === null ||
                    _a === void 0
                      ? void 0
                      : _a[0]
                  )
...
function init(playitOpts) {
  ...
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, new PlayIt().create(playitOpts)];
        case 1:
          return [2 /*return*/, _a.sent()];
      }
    });
